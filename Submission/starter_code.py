...
'''
Starter code from assignment instructions
    - automatically creates a train, dev, and test set
    - evaluates the results
'''

def evaluate(test_sentences, tagged_test_sentences, print_results=True):
